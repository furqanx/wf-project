...
-- 4a. Canonical valid-order fee coverage. Fee rows linked to an excluded raw
-- marketplace duplicate are reassigned to its canonical order fingerprint.
WITH order_resolution AS (
    ...
    SELECT sales_order_id, source_system, store_id, order_date
