...
def main() -> None:
    ...
    receipt_list = fetch_receipt_list(
        client,
    ...
    for index, receipt in enumerate(receipt_list, start=1):
        ...
        receipt_detail = fetch_detail(client, "/api/sales-receipt/detail.do", receipt_id)
    ...
    for index, (invoice_id, receipt_context) in enumerate(invoice_receipt_context.items(), start=1):
        ...
        invoice = fetch_detail(client, "/api/sales-invoice/detail.do", invoice_id)
