...
def current_issues_body_sql(target_schema: str) -> str:
    ...
    return f"""
        SELECT
            ...
            fss.currency_code,
            COALESCE(fss.released_at, fss.settled_at, fss.order_created_at) AS issue_occurred_at,
        ...
        SELECT
            ...
            fssa.currency_code,
            fssa.adjustment_occurred_at AS issue_occurred_at,
...
def upsert_sql(target_schema: str) -> str:
    ...
    ON CONFLICT (issue_key) DO UPDATE SET
        ...
        issue_occurred_at = EXCLUDED.issue_occurred_at,
