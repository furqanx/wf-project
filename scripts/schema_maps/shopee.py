...
SHOPEE_INCOME_SF_COLUMN_MAP = {
    ...
    'Biaya Layanan Gratis Ongkir XTRA (4.0%)' : 'biaya_layanan_gratis_ongkir_xtra_4_0',
    'Biaya Layanan Gratis Ongkir XTRA (4.5%)' : 'biaya_layanan_gratis_ongkir_xtra_4_5',
    'Biaya Layanan Gratis Ongkir XTRA (Kategori D)' : 'biaya_layanan_gratis_ongkir_xtra_kategori_d',
    'Biaya Layanan Gratis Ongkir XTRA (Kategori E)' : 'biaya_layanan_gratis_ongkir_xtra_kategori_e',
    'Biaya Layanan Gratis Ongkir XTRA - Ukuran Biasa (Kategori D)' : 'biaya_layanan_gratis_ongkir_xtra_ukuran_biasa_kategori_d',
    'Biaya Layanan Gratis Ongkir XTRA - Ukuran Biasa (Kategori E)' : 'biaya_layanan_gratis_ongkir_xtra_ukuran_biasa_kategori_e',
    'Biaya Layanan Gratis Ongkir XTRA - Ukuran Khusus (Kategori E)' : 'biaya_layanan_gratis_ongkir_xtra_ukuran_khusus_kategori_e',
    'Biaya Layanan Promo XTRA'              : 'biaya_layanan_promo_xtra',
    'Biaya Layanan Promo XTRA+'             : 'biaya_layanan_promo_xtra_plus',
    'Biaya Pembayaran'                      : 'biaya_pembayaran',
    'Biaya Program Shopee Live Xtra'        : 'biaya_program_shopee_live_xtra',
    'Biaya Campaign BRS 2024'               : 'biaya_campaign_brs_2024',
