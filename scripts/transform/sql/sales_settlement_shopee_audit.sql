...
resolved_rows AS (
    SELECT
        ...
        fso.sales_order_id AS exact_sales_order_id,
        CASE
...
UNION ALL
SELECT 'matched_by_order_id_fallback_rows', COUNT(*)::bigint, 'Rows matched to fact_sales_order by unique Shopee order id despite source store mismatch.'
FROM resolved_rows
WHERE matched_by_order_id_fallback
UNION ALL
